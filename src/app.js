    ...
    */
    $.fn.listItems = function(options) {
        ...
        const defaultOptions = {
            ...
            noData: 
                `<li class="no-students">
                    <span>Sorry, no students here</span>
                </li>`
        };
        ...
        */
        const API = {
            ...
            */
            buildPager() {
                ...
                for (let i = 0; i < state.totalPages; i++) {
                    pages += 
                        `<li class="page-link${i === state.page ? " state_active" : ""}" data-page="${i}">
                            ${i + 1}
                        </li>`;
                }
            ...
            */
            ...
            bindListEvents() {
                if(hasPager) {
                    const pages = pagerContext.find(".page-link");
                    pages.click((e) => {
